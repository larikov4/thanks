...
//            this._refreshWidth();
        ...
        editItem: function(item) {
            ...
            $("#jsGrid").trigger("editFormRendered", item.id);
        },
...
(function(jsGrid, $, undefined) {
    ...
    SelectField.prototype = new NumberField({
        ...
        itemTemplate: function(value) {
            ...
            if (resultItem.hex && resultItem.hex.match(/^#([0-9a-fA-F]{6}|[0-9a-fA-F]{3})$/i)){
                var color = $("<span>").addClass('color').css('background-color', resultItem.hex);
                result = color.prop('outerHTML') + result;
            }
            return result;
        },
        ...
        editTemplate: function(value) {
            ...
            (value !== undefined) && $result.find('.select2-container').select2('val', value);
            return $result;
        },
        ...
        insertValue: function() {
            var val = this.insertControl.find('.select2-container').select2('val');
            return this.valueType === "number" ? parseInt(val || 0, 10) : val;
        },

        editValue: function() {
            var val = this.editControl.find('.select2-container').select2('val');
            return this.valueType === "number" ? parseInt(val || 0, 10) : val;
        },

        _createSelect: function() {
            var $result = $("<select class='form-control select select-primary select-block'>"),
                valueField = this.valueField,
                textField = this.textField,
...
(function(jsGrid, $, undefined) {
    ...
    CheckboxField.prototype = new Field({
        ...
        itemTemplate: function(value) {
            ...
            checkbox.find('input')
                .radiocheck(value?"check":"uncheck")
                .radiocheck('disable');
            return checkbox;
        },
        ...
        editTemplate: function(value) {
            ...
            var checkbox = this._createCheckbox();
            checkbox.find('input').radiocheck(value?"check":"uncheck")
            var $result = this.editControl = checkbox;
            return $result;
        },
        ...
        insertValue: function() {
            return this.insertControl.find('input').prop('checked');
        },

        editValue: function() {
            return this.editControl.find('input').prop('checked');
        },

        _createCheckbox: function() {
            var $input = $("<input>")
                .attr("type", "checkbox")
                .attr("id", 'checkbox' + counter);
            var $label = $("<label>")
                .addClass('checkbox')
                .attr("for", 'checkbox' + counter++)
                .append($input);
            $input.radiocheck();
            return $label;
        }
